...
{\small
  \begin{mathpar}
   ...
   \inferrule[GenQubit]{}
       {\Cella{P}{n}{a}\qcell{t}_{\textsf{gt}}\longrightarrow \Cella{P}{n+}{a}\qcell{t}_{\textsf{gt}}}\;\;\texttt{when}\;t \texttt{|} \beta
  ...
  \inferrule[topup]{}
      { \qcell{(p.c.m)}_{\textsf{comm}}\qcell{\rho}_{\textsf{at}}\qcell{t}_{\textsf{gt}} \xrightarrow{c.m} 
        \qcell{\emptyset}_{\textsf{comm}}\qcell{\rho[c.m\mapsto \rho(c.m)\odot p]}_{\textsf{at}}\qcell{t}_{\textsf{gt}}}\;\;\texttt{when}\;\rho(c.m)\odot p<\mu
