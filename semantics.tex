...
\mprset{flushleft}
   \inferrule[GC]{}
       {\pcell{\pard{\qsend{p}{c}{m}^t.P}{...}}{\cn{S}\;i}{c_1}\pcell{ ...}{\cn{S}\;j}{c_2}
        \qcell{\emptyset}{\cn{comm}}\qcell{b}{\cn{pred}}
        \longrightarrow \pcell{\pard{P}{...}}{i}{c_1}\pcell{\pard{\qsend{p}{c}{m}^t}{...}}{j}{c_2}
               \pcell{(p.c.m)^t}{c_1\rightarrow c_2}{\cn{comm}}\qcell{b}{\cn{pred}}}

  \inferrule[PC]{\overline{P}\xrightarrow{\alpha^t} \overline{Q} }
      { \pcell{\overline{P}}{n}{c}\qcell{\emptyset}{\cn{comm}}\qcell{b}{\cn{pred}}
           \longrightarrow
         \pcell{\overline{Q}}{n}{c}\pcell{\alpha^t}{c}{\cn{comm}}\qcell{b}{\cn{pred}}}
...
There are other cells storing the environment information. 
The \cn{gt} cell ($\qcell{t}{\cn{gt}}$) is a global clock that times every QAM transitions. Cells \cn{comm} and \cn{pred} are the QAM ways to define side conditions, since rule syntax does not allow side condition definitions, explained shortly below. 
