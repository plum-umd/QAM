...
{\small
  \begin{mathpar}
   ...
   \inferrule[GenChan]{}
       {\Cellb{\qsend{p}{c}{m}^t}{i}{a}\Cella{P}{j}{b} \qcell{\{(a,b,p)\}\cup R}_{\cn{rel}}\qcell{t'}_{\cn{gt}}
        \longrightarrow \Cellb{}{i-}{a}\Cella{\qsend{p}{c}{m}^{t}\texttt{|}P}{j-}{b}
              \qcell{\{(a,b,p)\}\cup R}_{\cn{rel}}\qcell{t'+}_{\cn{gt}} }
...
\ignore{
  ...
  \inferrule[Communication]{}
      { \qcell{\qsend{p}{c}{m}^t\texttt{|} \qrev{c}{x}.P}^n_c\qcell{t'}_{\cn{gt}}\qcell{\rho}_{\cn{pred}}\qcell{\Fs}_{\cn{add}}
           \xrightarrow{c.m}  
         \qcell{P[m/x]}^n_c\qcell{t'+}_{\cn{gt}}
          \qcell{\mu,\rho}_{\cn{pred}}\qcell{\mu(\Fs,p,c.m,t,t')}_{\cn{add}} \\\texttt{when}\;\rho(\Fs,p,c.m,t,t')}
