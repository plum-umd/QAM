...
A configuration might contain one or more process cells $\qcell{P}^{n,t}_{c}$, representing the execution process of a local node,
...
{\small
  \begin{mathpar}
   ...
   \inferrule[GenChanT]{}
       {\Cellb{\qsenda{c}{m}}{i}{a}\Cella{P}{j}{b} \qcell{\{(a,b,p)\}\cup R}_{\cn{rel}}\qcell{t}_{\cn{gt}}
        \longrightarrow \Cellb{}{i-}{a}\Cella{\qsend{p}{c}{m}^t\texttt{|}P}{j-}{b}\qcell{\{(a,b,p)\}\cup R}_{\cn{rel}} \qcell{t}_{\cn{gt}} }

   \inferrule[GenChan]{}
       {\Cellb{\qsend{p}{c}{m}^t}{i}{a}\Cella{P}{j}{b} \qcell{\{(a,b,p)\}\cup R}_{\cn{rel}}
        \longrightarrow \Cellb{}{i-}{a}\Cella{\qsend{p}{c}{m}^t\texttt{|}P}{j-}{b}\qcell{\{(a,b,p)\}\cup R}_{\cn{rel}} }


   \inferrule[GenQubit]{}
       {\Cella{P}{n,t'}{a}\qcell{t}_{\cn{gt}}\longrightarrow \Cella{P}{n+,t}{a}\qcell{t}_{\cn{gt}}}\;\;\texttt{when}\;t \texttt{|} \beta\wedge t' < t
  ...
  \inferrule[Communication]{}
      { \qcell{\qsend{p}{c}{m}^t\texttt{|} \qrev{c}{x}.P}^n_c\qcell{\emptyset}_{\cn{comm}}
           \longrightarrow  
         \qcell{P[m/x]}^n_c\qcell{\qsend{p}{c}{m}^t}_{\cn{comm}}}
    
  \inferrule[topup]{}
      { \qcell{\qsend{p}{c}{m}^{t'}}_{\cn{comm}}\qcell{\rho}_{\cn{at}}\qcell{t}_{\cn{gt}} \xrightarrow{c.m} 
        \qcell{\emptyset}_{\cn{comm}}\qcell{\rho[c.m\mapsto \rho(c.m)\odot p]}_{\cn{at}}\qcell{t+}_{\cn{gt}}}\;\;\texttt{when}\;\rho(c.m)\odot p<\mu\wedge t - t' < \nu

  \inferrule[RelationUp]{}
      { \qcell{R}_{\cn{r}}\qcell{\Fs}_{\cn{fun}}\qcell{t}_{\cn{gt}} \longrightarrow
            \qcell{\Fs(t)}_{\cn{r}}\qcell{\Fs}_{\cn{fun}}\qcell{t}_{\cn{gt}}}
