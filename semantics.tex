...
and $\overline{\rules}$ is a set of rule for guiding how the configuration is transited, at least contain rules \rulelab{GC}, \rulelab{MT}, \rulelab{NoTries}, \rulelab{PC}, and \rulelab{Com} in \Cref{fig:q-pi-semantics}. 
...
Rules \rulelab{MT} and \rulelab{NoTries} define the behaviors of the replication $\comp{P}$.
