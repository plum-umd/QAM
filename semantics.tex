...
$\textcolor{blue}{\text{Semantics:}}\\$
  \begin{mathpar}
   \inferrule[Self]{}
       {\down{c}{\send{m}{P}} \longrightarrow \parll{\send{m}{P}}{c}{\scell{\emptyset}}}

   \inferrule[Cohere]{}
       { \pard{\parll{P}{c}{\scell{...}}}{\down{c}{Q}} \longrightarrow \parll{P}{c}{\scell{\pard{Q}{...}}}}

   \inferrule[Decohere]{}
       {\parll{P}{c}{\scell{\pard{Q}{...}}} \longrightarrow \pard{\parll{P}{c}{\scell{...}}}{Q} }
  ...
  \inferrule[Com]{}
      { \pard{\csend{\overline{c}}{m_l}{P}}{\crev{c}{x}{Q}}
           \xrightarrow{m_l} \pard{P}{Q[m_l/x]}}
...
Similar to \rulelab{Heating} and \rulelab{Cooling} rules in chemical abstract machine,
